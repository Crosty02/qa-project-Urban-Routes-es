...
class UrbanRoutesLocators:
    ...
    RESERVE_TAXI_BUTTON = (By.XPATH, "//div[contains(@class, 'smart-button-wrapper')]/button[contains(@class, 'smart-button')]")
    MODAL_VISIBLE = (By.XPATH, "//div[contains(@class, 'modal') and contains(text(), 'Reservar')]")